...
'''
    ...
    with open(filename, 'w') as f:
        ...
        f.write('#include "%s"\n' % (header_name))
        f.write('#include "pugixml.hpp"\n')
        f.write('#include "utility/types.h"\n')
        f.write('#include "utility/assert_helper.h"\n')
        f.write('#include "utility/string_helper.h"\n')
        f.write('\n')
...
if __name__ == '__main__':
    ...
    write_source(def_list, os.path.basename(sys.argv[1]), sys.argv[2])
